...
const calculator = (price, operador) => {
  ...
  paragrafo.innerHTML = `Preço total: $ ${acumulador.toFixed(2)}`;
};
...
function cartItemClickListener(event, price) {
  ...
  if (acumulador < 0) {
    paragrafo.innerHTML = "Preço total: $ 0.00";
  }
}
...
const removeTotalPrice = () => {
  ...
  totalPrice.innerHTML = "Preço total: $ 0.00";
};

botao.addEventListener("click", removeOl);
botao.addEventListener("click", removeTotalPrice);
